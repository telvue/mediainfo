...
class Mediainfo
  ...
  class AudioStream < Stream
    ...
    def sample_rate
      return unless rate = samplingrate_string_before_type_cast
    ...
    alias_method :samplingrate_string, :sample_rate
  ...
  private
  def mediainfo!
    @last_command = "#{path} #{@escaped_full_filename} --Output=XML --Full --Language=raw"
    run_command!
  end
